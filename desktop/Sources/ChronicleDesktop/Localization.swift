...
final class DesktopLocalization: ObservableObject {
    ...
    private static let chinese: [String: String] = [
        ...
        "Revisit what you captured before.": "重温你之前捕获的内容。",
        "On this day": "历史上的今天",
        "Rediscover": "重新发现",
        "Nothing to revisit yet. Older captures will surface here over time.": "还没有可回顾的内容，较早的捕获会随着时间出现在这里。",
        "Sign in to review your synced captures.": "登录后可回顾已同步的捕获。",
