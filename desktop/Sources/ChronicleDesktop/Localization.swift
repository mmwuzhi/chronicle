...
final class DesktopLocalization: ObservableObject {
    ...
    private static let chinese: [String: String] = [
        ...
        "No matches.": "没有匹配项。",
        "Not relevant for this search": "与本次搜索无关",
        "Restore result": "恢复结果",
        "Show %d hidden results": "显示 %d 条已隐藏结果",
        "Hide dismissed results": "隐藏已排除结果",
        "Not related": "不相关",
        ...
        "Completed on": "完成日期",
        "Add completion date": "添加完成日期",
        "We couldn't update this task. Try again.": "无法更新这项任务，请重试。",
