    ...
    <>
      <nav className="ch-topbar">
        ...
        <div className="ch-topbar-right">
          ...
          <button className="ch-searchtrigger" onClick={() => setSearchOpen(true)}>
            <SearchIcon />
          ...
          {/* Mobile search icon */}
          <button className="ch-iconbtn ch-search-mobile" onClick={() => setSearchOpen(true)} aria-label={t("search.placeholder")}>
            <SearchIcon />
          </button>

          {/* Settings */}
          <Link to="/settings" search={{}} className="ch-iconbtn" aria-label={t("nav.settings")}>
            <SettingsIcon />
          </Link>
        </div>
      </nav>
